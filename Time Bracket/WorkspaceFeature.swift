...
struct MeetingWorkspaceScreen: View {
...
struct EmptyCalendarWorkspaceScreen: View {
    var body: some View {
        VStack(spacing: 0) {
...
enum SharedCalendarViewMode: String, CaseIterable, Identifiable {
    case mySchedule
    case teamResponses
...
struct CompactMeetingContextBar: View {
    let meeting: HomeMeeting
...
struct AvailabilityInputToolbar: View {
...
struct SharedCalendarToolbar: View {
...
struct CalendarDerivationTransitionOverlay: View {
    let onComplete: () -> Void
